...
export declare let inConnectFunc: boolean;
...
export declare let pathListenerCounts: {};
export declare function SetListeners(paths: string[]): void;
export declare function UnsetListeners(paths: string[]): void;
