...
function PostImageToGooglePlus(imageDataURI, message) {
...
exports.PostImageToGooglePlus = PostImageToGooglePlus;
function CallExtensionFunction(func) {
    var args = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args[_i - 1] = arguments[_i];
    }
    window.postMessage({ type: "3000Weeks_CallExtensionFunction", func: func, args: args }, "*");
}
